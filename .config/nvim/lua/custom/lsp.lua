...
vim.api.nvim_set_hl(0, "DiagnosticLineNrError", { fg = vim.api.nvim_get_hl(0, { name = "DiagnosticError" }).fg, bold = true })
vim.api.nvim_set_hl(0, "DiagnosticLineNrWarning", { fg = vim.api.nvim_get_hl(0, { name = "DiagnosticWarning" }).fg, bold = true })
vim.api.nvim_set_hl(0, "DiagnosticLineNrInfo", { fg = vim.api.nvim_get_hl(0, { name = "DiagnosticInfo" }).fg, bold = true })
vim.api.nvim_set_hl(0, "DiagnosticLineNrHint", { fg = vim.api.nvim_get_hl(0, { name = "DiagnosticHint" }).fg, bold = true })
